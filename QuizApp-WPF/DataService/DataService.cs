...
namespace QuizApp_WPF.DataService
{
            ...
            return await Task.FromResult(new List<Quiz>()
            {
                new Quiz(
                    ...
                    new List<Question>
                    {
                        ...
                        new Question(6, "What is 1 - 1?", new[] { "A. 2", "B. 1","C. 0" }, 3, "cat6.jpg", Categories.Substraction),
                        new Question(7, "What is 15 - 5?", new[] { "A. 9", "B. 10","C. 7" }, 2, "cat7.jpg", Categories.Substraction),
                        new Question(8, "What is 10 - 3?", new[] { "A. 5", "B. 6","C. 7" }, 3, "cat8.jpg", Categories.Substraction),
                        new Question(9, "What is 6 - 3?", new[] { "A. 5", "B. 3","C. 7" }, 2, "cat9.jpg", Categories.Substraction),
                        new Question(10, "What is 5 - 2?", new[] { "A. 4", "B. 3","C. 6" }, 2, "cat10.jpg", Categories.Substraction),
